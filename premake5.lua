...
local BGFX_DIR = os.getenv("CPP_SDK_HOME") .. "/bgfx"
local BIMG_DIR = os.getenv("CPP_SDK_HOME") .. "/bimg"
local BX_DIR = os.getenv("CPP_SDK_HOME") .. "/bx"
local GLFW_DIR = os.getenv("CPP_SDK_HOME") .. "/glfw"
